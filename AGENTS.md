...
- Run `uv run departurepixelzh-builder build --recipe ../X-DeparturePixelZh/recipe.json --output Build`.
- Run `uv run departurepixelzh-builder check --recipe ../X-DeparturePixelZh/recipe.json --output Build` before packaging.
